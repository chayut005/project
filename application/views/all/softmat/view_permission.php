...
<div class="content-wrapper pa">
	...
	<section class="content">
		<div class="vvv2">
			...
			<button style="color:white;background: linear-gradient(45deg, #75D247, #2ABF00 , #1F9B00);"
				data-target="#modal_peradd" data-toggle="modal" class="btn bg-success button1 "><i
						...
						<form name="frmadd" id="frmadd" method="post">
							...
							<section>
								<label>Status :
									...
									<input type="radio" name="rad_status" id="disable" value="0" /><label title="2"
				...
				<div class="modal-content">
					...
					<div class="vvv2">
						...
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-unlock"></i></span>
							<input name="txt_name" type="text" class="form-control" placeholder="Permission Name"
								value="<?php echo $perDataEdit['name']; ?>">
						</div>
						...
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-pencil"></i></span>
							<input name="txt_cont" type="text" class="form-control" placeholder="Controller/Method"
								value="<?php echo $perDataEdit['controller']; ?>">
						</div>
						...
						<section>
							...
							<div class="radio">
								<label>Status :
									<input checked="checked" type="radio" id="under_10" name="rad_status" value="1"
										<?php echo set_radio('rad_status', '1', TRUE); ?>><label
										for="under_10">Enable</label>
									<input type="radio" id="over_10" name="rad_status" value="0"
										<?php echo set_radio('rad_status', '0'); ?>><label for="over_10">Disable</label>
								</label>
							</div>
			...
			columns: [{
				...
				},
				{
					...
					"render": function (data, type, row, meta) {
						if (type === 'display') {
							html_data =
								'<button style="color:white;background: linear-gradient(45deg, #75D247, #2ABF00 , #1F9B00);" onclick="submit(' +
								data +
								')" class="btn bg-success button1"><i class="fa fa-edit "></i></button> <button style="color:white;background: linear-gradient(45deg, #FF9797, #DE321F , #DE321F);" onclick="btndelete(' +
								data +
								')" class="btn bg-danger button1"><i class="fa fa-bitbucket"></i></button>';
						}
						return html_data;
					}
